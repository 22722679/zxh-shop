...
type RPCClient interface {
	...
	ListOrder(ctx context.Context, Req *order.ListOrdertReq, callOptions ...callopt.Option) (r *order.ListOrderResp, err error)
}
...
func (c *clientImpl) ListOrder(ctx context.Context, Req *order.ListOrdertReq, callOptions ...callopt.Option) (r *order.ListOrderResp, err error) {
