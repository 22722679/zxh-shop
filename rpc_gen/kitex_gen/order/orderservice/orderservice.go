...
var ListOrderArgs_Req_DEFAULT *order.ListOrdertReq

func (p *ListOrderArgs) GetReq() *order.ListOrdertReq {
	if !p.IsSetReq() {
...
func (p *kClient) ListOrder(ctx context.Context, Req *order.ListOrdertReq) (r *order.ListOrderResp, err error) {
